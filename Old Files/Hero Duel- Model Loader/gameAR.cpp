...
/* Object Data */
char            *model_name = "Patterns/object_data2";
ObjectData_T    *object;
int             objectnum;
...
#ifdef _WIN32
char			*vconf = "Patterns\\WDM_camera_flipV.xml";
#else
char			*vconf = "";
#endif

char           *cparam_name = "Patterns/camera_para.dat";
ARParam         cparam;
...
int gameAR::draw( ObjectData_T *object, int objectnum )
{
    int     i;
    double  gl_para[16];
...
int gameAR::draw_object( int obj_id, double gl_para[16])
{
